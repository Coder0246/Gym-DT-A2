    ...
    <div class="container py-3">
        <header>
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                ...
                <p class="fs-5 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem nemo
                    ratione vero id ad et doloribus pariatur ipsa velit odio. Consequuntur est dolorem alias aspernatur
                    quaerat corrupti molestiae fugit officiis natus quisquam culpa odit, odio quos necessitatibus hic
                    quae architecto dolore quibusdam magni cumque enim! Molestiae eum quo illum voluptas.</p>
            </div>
        </header>
            ...
            <div class="col-lg-6">
                <div class="d-flex align-items-center">
                    <img class="flex-shrink-0 img-fluid rounded"
                        src="<?php echo APPIMAGES; ?>/<?php echo $meal_1->image; ?>" alt="" style="width: 80px;">
                    <div class="w-100 d-flex flex-column text-start ps-4">
                        ...
                        <a type="button" href="<?php echo APPURL; ?>/food/add-cart.php?id=<?php echo $meal_1->id; ?>"
